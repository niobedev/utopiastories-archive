...
_**Author\'s Note:**_This is only the first part of what hopefully will be a fairly long story set in an indefinite far-future. The government as we know it has collapsed, and crime syndicates and influential families run the show.

This is my first effort, so let me know what you think!*
