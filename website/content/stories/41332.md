...
_**Author\'s Note:**_This is version 2 - A rewrite of the original to address the valid comments given about the story. The story line is about the same, but the details are considerably fleshed out and the last half is a major rewrite.*
