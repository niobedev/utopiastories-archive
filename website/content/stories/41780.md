...
_**Author\'s Note:**_Warning: A small part of the below story involves a child unwittingly playing with a remote control that is connected to an unseen adult woman. At NO point does the child see anything inappropriate nor is he seen in any inappropriate way. At NO point is the child touched in anyway even remotely inappropriate nor does the child have any opportunity to touch anyone else in an inappropriate way. That said if you don't want to read a story that includes a child in ANY way, regardless of how innocently, you should avoid this story.*
