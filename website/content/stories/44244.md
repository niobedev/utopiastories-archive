...
_**Author\'s Note:**_This is part 2 of the story I began in "A Model Worker" back in September, and further develops the central characters and themes. It is a darker tale than the first installment, so please check the story codes for what to expect. I plan to write further installments to this story when I can find time.*
