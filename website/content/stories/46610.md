...
_**Author\'s Note:**_Dear Reader, I submit this story for publication, not that I expect a single person to believe it's true in any aspect, but because I must write it down to sort out the events that it relates, if only for my own sanity. It is for my own therapy that I write, not for your enjoyment. Comment on it as you see fit - it is of no concern to me. -Darios. 10/12/84*
