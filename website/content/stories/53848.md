...
_**Author\'s Note:** This story returns to the same characters introduced by my first story, _Abducting An Angel*. I suggest reading that one first (or at least the first section) to get an appreciation for the characters, but it's not strictly necessary in order to follow this story.*
