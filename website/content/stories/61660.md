...
_**Author\'s Note:**_This started out as the kernel of an idea for a potential video/photo shoot which I would like to put together. Putting things on paper, and following the natural progression of a bondage scene, helps me recognise what will and won't work before the camera rolls. The back story is fictional, but I have drawn on inspiration from several people I have talked to and pieces of equipment that I have, or would like to make, to allow this to happen. Finally, please bear in mind that this is written by a Brit. Our language and spelling is slightly different from the American version of our shared language.*
