...
_**Author\'s Note:**_This story is based on a captioned image that I found while browsing the internet. I also took some (read: a lot of) artistic freedom with it, but the basic idea is the same.*
