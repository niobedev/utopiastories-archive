...
_**Author\'s Note:**_I used to write a lot but haven't done for years. I was recently inspired by a friend to get back to writing, and so this is my first attempt in a long time. I realise I have slipped accidentally into present tense in a few places - hopefully this is not too off putting.*
