---
original_url: https://utopiastories.com/code/show_story.asp/recid/75226.html
authors:
- Onkana
tags:
- F-f
...
_**Author's Note:** English is not my native language, so if there are some writting mistakes, I apologize._

_How can we learn to love the light if we've never been in the dark? The story seems pretty dark and sad in the first part, but please, be patient. The main character is deaf, so every sentence written_like this* means that someone is using sign language.*
