...
_**Author\'s Note:** The old truth applies: Be careful what you ask for...

This is not (quite) a true story, but it is one that could happen and most parts of it has actually happened. It has the element of consent in it, but from the perspective that consent is given once and can't then be withdrawn until terms have been met. Where the story references real events, names have been changed to protect the (not so) innocent._
