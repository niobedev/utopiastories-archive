...
_**Author\'s Note:**_I am experimenting again. Sorry, usual slow stuff I'm afraid. This time trying a two-part tale using some characters from my 'Such a nice kind lady' story. Sort of a carry on from that but as a stand-alone tale. Starts with an abbreviated clip from that story for main characters descriptions.*
