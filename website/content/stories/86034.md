...
_**Author\'s Note:**_Story inspired by enema artwork from the artist Augustine and stories by the same. Primarily focuses on enemas and pipelining, forced fluid recycling and such, so if that's not your thing I'd suggest skipping this.
