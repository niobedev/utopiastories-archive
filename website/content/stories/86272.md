...
_**Author\'s Note:** Sarah goes for a modeling gig, but is soon captured and tormented. Inspired by a classic Insex scene._

_This story is a little different than some of my others. This is something of a novelization of a classic video that caught my eye from the geniuses at Insex. It is my best attempt to capture, in story form, the contents of the scene. I'll try to include a link to the video at the end (not sure if that's frowned upon). Enjoy!_
